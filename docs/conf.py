...
project = u'ImageKit'
copyright = u'2011, Matthew Tretter'
...
latex_documents = [
  ('imagekit', 'ImageKit.tex', u'ImageKit Documentation',
...
man_pages = [
    ('imagekit', 'imagekit', u'ImageKit Documentation',
     [u'Matthew Tretter'], 1)
]
...
texinfo_documents = [
  ('imagekit', 'ImageKit', u'ImageKit Documentation', u'Matthew Tretter',
